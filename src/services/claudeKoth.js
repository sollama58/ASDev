 ...
 * Candidate rows carry a source label for the UI.
 */
...
async function getKothWithFallback(db, algorithmFallback) {
    ...
    try {
        // Get the top 10 platform tokens by 24hr volume
        ...
        const platformCount = candidates.length;
        ...
        await logEvaluation({
            ...
            platformCount,
            queryDurationMs: queryDuration,
            message: `Top 10 platform tokens by 24hr volume`
        });
